    ...
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col 4 ms-5">
                <h5 class="mt-5 text-white">Nossas turmas</h5>
                <!-- <a href="#" class="btn btn-primary btn-lg" tabindex="-1" role="button" aria-disabled="true">Agendar visita</a> -->
                <ul class="list-unstyled mt-4 text-white">
                    <li class="mb-3">Ensino Infantil Um</li>
                    <li class="mb-3">Ensino Infantil Dois</li>
                    <li class="mb-3">Ensino Infantil Tres</li>
                </ul>
            </div>
            <div class="col 4  ms-5">
                <h5 class="mt-5 text-white">Contatos</h5>
                <ul class="list-unstyled mt-4 text-white">
                    <li class="mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-phone-fill me-1" viewBox="0 0 16 16">
            ...
            <div class="col 4  ms-5">
                <h5 class="mt-5 text-white">Nossos canais</h5>
                <ul class="list-unstyled mt-4 text-white">
                    <li class="mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram me-1" viewBox="0 0 16 16">
