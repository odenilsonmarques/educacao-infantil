                ...
                <?php for ($i = 1; $i <= get_theme_mod('setting_carousel_slide_count', 3); $i++) : ?>
                    <div class="image-wrapper carousel-item <?php echo $i === 1 ? 'active' : ''; ?>">
                        ...
                        <div class="carousel-caption text-start w-50">
                            <h5><?php echo esc_html(get_theme_mod("carousel_title_$i")); ?></h5>
                            <p><?php echo esc_html(get_theme_mod("carousel_description_$i")); ?></p>
                            <a href="<?php echo esc_url(get_theme_mod("carousel_button_link_$i")); ?>" class="btn btn-lg border-0 w-50" tabindex="-1" role="button" aria-disabled="true">
